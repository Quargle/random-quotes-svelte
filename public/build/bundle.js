    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 70, 2, 1782);
    			attr_dev(div1, "id", "author");
    			attr_dev(div1, "class", "svelte-n418xs");
    			add_location(div1, file, 71, 2, 1814);
    			...
    			add_location(button, file, 73, 3, 1875);
